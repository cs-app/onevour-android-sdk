package com.onevour.core.utilities.ui.viewpager;
//
// Created by  on 2019-12-08.
//
...
public class ViewPagerState extends ViewPager {
    ...
    public ViewPagerState(Context context) {
        super(context);
    }

    public ViewPagerState(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void restoreViewState(int position, View view) {
        ...
        if (state == null) {
            Log.d(ViewPagerState.class.getSimpleName(), "State for view restore was null");
        } else {
            try {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (tag != null) {
                try {
                    ...
                    Log.d(ViewPagerState.class.getSimpleName(), "View probably didn't have a proper positional tag", e);
                }
            }
        }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof Bundle)) {
            ...
            if (viewStates == null) {
                Log.d(ViewPagerState.class.getSimpleName(), "No view states to restore");
                return;
            }
